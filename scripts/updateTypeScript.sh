...
cp ../typescript/lib/lib.d.ts $(dirname $0)/../com.palantir.typescript/bridge/lib/
cp ../typescript/lib/tsc.js $(dirname $0)/../com.palantir.typescript/bridge/lib/

# copy the language services JavaScript and definition file
cp ../typescript/lib/typescriptServices.js $(dirname $0)/../com.palantir.typescript/bridge/lib/
cp ../typescript/lib/typescriptServices.d.ts $(dirname $0)/../com.palantir.typescript/bridge/typings/

# copy the default lib files into the plug-in
cp ../typescript/lib/lib.d.ts $(dirname $0)/../com.palantir.typescript/src/com/palantir/typescript/services/language/
cp ../typescript/lib/lib.es6.d.ts $(dirname $0)/../com.palantir.typescript/src/com/palantir/typescript/services/language/
